  ...
  return (
    <div className="min-h-screen w-full relative">
      <Dither
        ...
        enableMouseInteraction={false} // Disable mouse interaction by default for better performance
        mouseRadius={0.3}
        colorNum={4}
        waveAmplitude={0.3}
        waveFrequency={3}
      ...
      <div className="container mx-auto py-8 px-4 sm:px-6 relative z-10">
              ...
              <div className="flex-shrink-0">
                <div className="relative">
                  <img
                    ...
                    width={160}
                    height={160}
                    className="w-32 h-32 md:w-40 md:h-40 rounded-full object-cover border-4 border-primary shadow-[0_0_15px rgba(57,197,187,0.4)] md:hover:scale-110 md:transition-transform md:duration-300"
                  />
                </div>
              </div>
              ...
              <div className="flex flex-col items-center md:items-start text-center mx:text-left">
                ...
                <div className="flex flex-wrap justify-center md:justify-start gap-4 mt-4">
                  <div className="flex items-center gap-2 text-gray-300">
                    ...
                    <a href={`mailto:${portfolio.email}`} className="md:hover:bg-neutral-400 md:transition-colors">
                      {portfolio.email}
                    </a>
                  </div>
                  <div className="flex items-center gap-2 text-gray-300">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {portfolio.socialLinks?.github && (
                <a
                  ...
                  className="flex flex-col items-center p-4 bg-black/40 rounded-lg md:hover:bg-black/60 md:transition-all md:duration-300 md:hover:scale-105"
                >
        ...
        <div className="max-w-5xl mx-auto mb-8">
          <Card className="p-6 bg-black/60 backdrop-blur-md border-none shadow-[0_0_15px rgba(57,197,187,0.2)] rounded-xl">
            <h2 className="text-2xl font-bold mb-6 text-white text-center">Skills & Expertise</h2>
            <div className="flex flex-wrap justify-center gap-3">
              {portfolio.skills.map((skill) => (
                <span
                  key={skill}
                  className="px-4 py-2 bg-black/50 border border-primary/30 rounded-full text-sm font-medium text-white md:hover:bg-primary/20 md:transition-colors md:duration-300 md:hover:scale-105"
                >
                  {skill}
                </span>
              ))}
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {portfolio.projects.map((project) => (
              <Card
                key={project.id}
                className="overflow-hidden bg-black/60 backdrop-blur-md border-none shadow-[0_0_15px rgba(57,197,187,0.2)] rounded-xl md:transition-all md:duration-300 md:hover:shadow-[0_0_25px rgba(57,197,187,0.4)] md:hover:translate-y-[-5px]"
              >
                  ...
                  <div className="flex justify-between">
                    {project.liveUrl && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-primary md:hover:text-pink-400 md:transition-colors font-medium"
                      >
                        Live Demo
                      </a>
                    )}
                    {project.githubUrl && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-gray-300 md:hover:text-primary md:transition-colors font-medium"
                      >
                        Source Code
                      </a>
                    )}
